...
describe('HeaderComponent - dom unit', () => {
  ...
  describe('onResize method', () => {
    const shouldBeCallOnResizeEventExpectation =
      'should be called on window resize event';
    const shouldBeCallOnResizeEvent = () => {
    ...
    describe('in dev environment', () => {
      ...
      it(shouldBeCallOnResizeEventExpectation, shouldBeCallOnResizeEvent);
    });
  ...
  describe('onScroll method', () => {
    const shouldBeCallOnScrollEventExpectation =
      'should be called on window scroll event';
    const shouldBeCallOnScrollEvent = () => {
    ...
    describe('in dev environment', () => {
      ...
      it(shouldBeCallOnScrollEventExpectation, shouldBeCallOnScrollEvent);
    });
  ...
  describe('DOM', () => {
    const shouldHaveProperDomStructExpectation =
      'should have proper dom structure';
    const shouldHaveProperDomStruct = () => {
      // loaded
      ...
      expect(debugEl.children[0].nativeElement.tagName)
        .withContext('child 1 at root is APP-LANGUAGE-MODAL')
        .toBe('APP-LANGUAGE-MODAL');
      ...
      expect(rightHeaderEl.children[0].nativeElement.tagName)
        .withContext(
          'child 1 of right header should be APP-BUTTON-BAR-ON-HOVER'
        )
      ...
      expect(debugEl.children[1].nativeElement.tagName)
        .withContext('child 2 at root is DIV')
        .toBe('DIV');
      const headerElLoading: DebugElement = debugElLoading.children[1];
      ...
      expect(headerElLoading.children[0].nativeElement.tagName)
        .withContext('child 1 of child 1 at root should be DIV')
        .toBe('DIV');
      const headerContainerElLoading: DebugElement =
        headerElLoading.children[0];
      ...
      expect(rightHeaderElLoading.children[1].nativeElement.tagName)
        .withContext(
          'child 2 of right header should be APP-BUTTON-BAR-ON-HOVER'
        )
        .toBe('APP-BUTTON-BAR-ON-HOVER');
      // collapsed-header
      ...
      expect(deroulantElLoading.children[1].nativeElement.tagName)
        ...
        .toBe('UL');
      // collapsed-header deroulant div
      const deroulantDivElLoading: DebugElement =
        deroulantElLoading.children[0];
    ...
    const shouldSetMyNameExpectation = 'should set myName';
    const shouldSetMyName = () => {
      componentInstance.updateTexts();
      fixture.detectChanges();
    ...
    const shouldSetSetLanguageExpectation = 'should set setLanguage';
    const shouldSetSetLanguage = () => {
      componentInstance.updateTexts();
      fixture.detectChanges();
    ...
    describe('in dev environment', () => {
      ...
      it(shouldHaveProperDomStructExpectation, shouldHaveProperDomStruct);
      it(shouldSetMyNameExpectation, shouldSetMyName);
      it(shouldSetSetLanguageExpectation, shouldSetSetLanguage);
    });
